 ...
 <div class="container">
  <div class="row mt-4">
    <div class="col-md">
      ...
      <div class="form-group row">
        ...
        <div class="col-lg-3">
          <select class="form-control" id="CodigoEmpleado">
            ...
            echo "<option value='0'>Seleccionar Empleado</option>";
      ...
      <div class="form-group row">
        <label for="Comentario" class="col-lg-3 col-form-label">Comentario:</label>
        <div class="col-lg-3">
          <input type="text" class="form-control" id="Comentario" value="">
        </div>
      </div>
    </div>
  </div>
...
<script>
 ...
 $('#btnConfirmarFactura').click(function() {
  ...
  function EnviarInformacionFactura(accion) {
    ...
    data: cliente, 
    success: function(msg) {
       window.location = '../Ventas/Mos_Facturas.php';
    },
    error: function() {
     window.location = '../Ventas/Mos_Facturas.php';
    }
