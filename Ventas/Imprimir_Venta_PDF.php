...
<body>
 <form method="Post"> 
  <div class= "col-md-3"> 
    <label for="nropedido">Digite número de pedido:</label> 
    <input type="text" class="form-control" name="nropedido"> 
  </div> 
...
function cabecera($fpdf, $conexion)
{
    ...
    $datos = mysqli_query($conexion, "select empresa,
                                         ...
                                         where pedido.nropedido=$_POST[nropedido]") or die(mysqli_error($conexion));
...
function imprimirdetalle($fpdf, $conexion)
{
    $datos = mysqli_query($conexion, "select pro.codigo as codigo,
                                          ...
                                          where nropedido=$_POST[nropedido]") or die(mysqli_error($conexion));
